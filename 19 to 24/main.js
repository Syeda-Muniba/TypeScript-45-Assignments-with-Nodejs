// Exercise 19
var guestList = ["Humna", "Yamna", "Fabiha", "Muniba"];
var numofGuests = guestList.length;
console.log("We are Inviting total ".concat(numofGuests, " guests."));
// Exercise 20
// Making a Favourite Colour Array List
var favColour = ["Black", "Brown", "Blue", "Mehroon"];
// Print the message of List
console.log("List of Favourite Colour:");
// Print the values of Array in the form of List 
favColour.forEach(function (colour) { return console.log(colour); });
var itCourse = {
