...
// Exercise 17
// Creating a Guest List Array
var guestList4 = ["Hafsa", "Yamna", "Fabiha", "Muniba"];
// Making variable for those guest who cant come
var cantCome = guestList4[0];
// Print the name of guest who cant come
...
// Get a middle index of our guest list array 
var middleindex = Math.floor(guestList4.length / 2);
// Adding a new guest to middle index of array 
guestList4.splice(middleindex, 0, "Aniqa");
// Print message of Updated List
console.log("Updated List of our Guests");
// Sending a invitation message to our guests one by one with thier names 
guestList4.forEach(function (oneguest) { return console.log("Salam ".concat(oneguest, ", would you like to dinner with me?")); });
...
guestList4.forEach(function (lasttwo) { return console.log("Luckly ".concat(lasttwo, ", you are still invited to dinner")); });
